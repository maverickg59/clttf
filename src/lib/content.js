...
export const SUPPORT_CARDS = [
  [
    {
      title: 'Funding:',
      text:
        'Funding helps us cover administrative expenses and scholarships for the purchase of training and equipment. Our primary goal is to help students learn to ride more safely, but we need your help!',
    },
    {
      title: 'Gear:',
      text: (
  ...
  [
    ...
    },
    {
      title: 'Track Days:',
      text:
        'You can even help grant scholarships by donating track day and training sessions.',
    },
  ],
]
